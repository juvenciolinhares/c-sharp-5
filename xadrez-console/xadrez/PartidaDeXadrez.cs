...
namespace xadrez
{
    internal class PartidaDeXadrez
    {
        ...
        public Peca executaMovimento(Posicao origem, Posicao destino)
        {
            ...
            if(p is Peao)//se for en passant, captura manualmente
            {
                //se mexeu na diagonal e a peça capturada é nula(nao pegou peça)
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if(p is Peao)
            {
                //se o movimento foi pra outra coluna(foi captura) e a peça capt foi a peça vulneravel
                if(origem.coluna != destino.coluna && pecaCapturada == vulneravelEnPassant)
                {
                    //a peça capturada tem que voltar pro lado da origem:
                    Peca peao = tab.retirarPeca(destino);//retirou a peça
                    Posicao posP;
                    if(p.cor == Cor.Branca)
                    {
